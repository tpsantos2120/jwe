...
public class JWEExample {
    ...
    public void runJWE() throws NoSuchAlgorithmException, InvalidKeySpecException, ParseException, JOSEException {
        // encrypt a JWT
        ...
        System.out.println("Public Key: " + Base64.getEncoder().encodeToString(publicRsaKey.getEncoded()));
        System.out.println("Private Key: " + Base64.getEncoder().encodeToString(privateRsaKey.getEncoded()));

        JWTClaimsSet.Builder claimsSet = new JWTClaimsSet.Builder();
        claimsSet.issuer("thiago");
        claimsSet.subject("JWE-Authentication");
        ...
        JWEHeader header = new JWEHeader(JWEAlgorithm.RSA_OAEP_512, EncryptionMethod.A256CBC_HS512);
